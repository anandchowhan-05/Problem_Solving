# 📝 3917. Count Indices With Opposite Parity (LeetCode)

🔗 [Problem Link](https://leetcode.com/problems/count-indices-with-opposite-parity/?envType=problem-list-v2&envId=array)
